...
from od.core.box_ops import transform_fpcoor_for_tf, compute_iou, compute_intersection, compute_area
...
def test_transform_fpcoor_for_tf():
    ...
    normalized_boxes = transform_fpcoor_for_tf(tf.constant([[1, 1, 3, 3]], tf.float32), [5, 5],
                                               [4, 4])
...
def test_compute_area():
    ...
    areas_output = compute_area(boxes)
...
def test_compute_intersection():
    ...
    intersect_output = compute_intersection(boxes1, boxes2)
...
def test_compute_iou():
    ...
    iou_output = compute_iou(boxes1, boxes2)
...
def test_compute_iou_works_on_empty_inputs():
    ...
    iou_empty_1 = compute_iou(boxes1, boxes_empty)
    iou_empty_2 = compute_iou(boxes_empty, boxes2)
    iou_empty_3 = compute_iou(boxes_empty, boxes_empty)
