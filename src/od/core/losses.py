...
class FocalBinaryCrossentropy(losses.Loss):
    ...
    def call(self, y_true, y_pred):
        per_entry_cross_ent = (losses.binary_cross_entropy(y_true, y_pred, from_logits=True))
        prediction_probabilities = tf.sigmoid(y_pred)
