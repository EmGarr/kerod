...
def preprocess_input(images: tf.Tensor):
    ...
    The network has been trained using BGR. However, for the sake of the user all the preprocessing
    are done in RBG and the network with its preprocessing function will convert BGR to RGB.
    """
    # RGB to BGR
    images = images[:, :, ::-1]
